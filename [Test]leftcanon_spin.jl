...
MPS_left=Array{Complex{Float64},3}[]; #defines an array of rank 3 tensors (for MPS)
#initialize leftcanon as a tensor
r_arr=fill(0,L-1);#array of bond dimension of the tensors only L-1 because first and last tensors have only 1 index each
